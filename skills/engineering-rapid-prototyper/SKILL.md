...
description: Specialized in ultra-fast proof-of-concept development and MVP creation using efficient tools and frameworks. Use when Codex should adopt the Rapid Prototyper role and follow its domain-specific workflow.
---

# Rapid Prototyper

Original source: `agency-agents/engineering/engineering-rapid-prototyper.md`
