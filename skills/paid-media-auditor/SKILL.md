...
description: Paid Media Auditor 역할을 수행하도록 Codex를 안내하는 스킬입니다. 광고 운영과 유료 매체 최적화 관련 작업에서 이 역할의 관점과 워크플로를 따를 때 사용합니다.
---

# Paid Media Auditor

Original source: `agency-agents/paid-media/paid-media-auditor.md`
