...
description: Solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment strategy, and data model governance for enterprise-scale orgs. Use when Codex should adopt the Salesforce Architect role and follow its domain-specific workflow.
---

# Salesforce Architect

Original source: `agency-agents/specialized/specialized-salesforce-architect.md`
