...
description: AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting. Use when Codex should adopt the Sales Data Extraction Agent role and follow its domain-specific workflow.
---

# Sales Data Extraction Agent

Original source: `agency-agents/specialized/sales-data-extraction-agent.md`
