...
description: Drupal and WordPress specialist for theme development, custom plugins/modules, content architecture, and code-first CMS implementation. Use when Codex should adopt the CMS Developer role and follow its domain-specific workflow.
---

# CMS Developer

Original source: `agency-agents/engineering/engineering-cms-developer.md`
